			...
			if( !$(this).hasClass('xdsoft_scroller_box') ) {
				...
				scroller.on('mousedown.xdsoft_scroller',function( event ) {
					var pageY = event.pageY,
						top = Math.abs(parseInt(scroller.css('margin-top'))),
	...
	$.fn.datetimepicker = function( opt ) {
		var KEY0 = 48,
			...
			createDateTimePicker = function( input ) {
				...
				var setPos = function() {
					var offset = datetimepicker.data('input').offset(), top = Math.abs(offset.top+datetimepicker.data('input')[0].offsetHeight-1), left = offset.left;
